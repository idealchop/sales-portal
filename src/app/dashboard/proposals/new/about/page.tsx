  ...
  return (
    <Card className="flex-1">
      ...
      <CardContent className="grid md:grid-cols-2 gap-8 items-start">
        <div className="space-y-6 text-sm text-muted-foreground prose">
        ...
        <div className="relative aspect-video rounded-lg overflow-hidden">
            <Image 
                src="https://firebasestorage.googleapis.com/v0/b/smartrefill-singapore/o/Sales%20Portal%2FMarketing%20Mats%2FSmartRefill_01.jpg?alt=media&token=44542ccf-f100-49c9-a131-f8fb25811557"
                alt="Smart Refill service"
                fill
                className="object-cover"
                data-ai-hint="water refill service"
            />
        </div>
      </CardContent>
    </Card>
