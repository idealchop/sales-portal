    ...
    <section className="space-y-4">
      <div>
        <h2 className="text-lg font-semibold text-foreground">
          Workspace map & owners
        </h2>
        <p className="text-sm text-[var(--muted-foreground)]">
          Pin map first — then open owners for plan history and approvals.
        </p>
      </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-[var(--muted-foreground)]">
                    Click a pin for plan and activity
                  </p>
                </div>
              </div>
              <div className="flex flex-wrap gap-2 text-xs">
                <span className="rounded-full bg-white px-3 py-1 font-medium text-teal-800 ring-1 ring-teal-100">
                  {mapLocations.length} pins
                </span>
                <span className="rounded-full bg-white px-3 py-1 font-medium text-zinc-700 ring-1 ring-zinc-100">
                  {onboarded} onboarded
                </span>
                <span className="rounded-full bg-white px-3 py-1 font-medium text-emerald-700 ring-1 ring-emerald-100">
